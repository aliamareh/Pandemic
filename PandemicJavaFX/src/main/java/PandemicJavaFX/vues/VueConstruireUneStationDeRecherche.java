...
public class VueConstruireUneStationDeRecherche extends Vue implements VueInteractive, EcouteurOrdre {
    ...
    public static VueConstruireUneStationDeRecherche creerVue(GestionnaireVueImpl gestionnaireVue)  {
        FXMLLoader fxmlLoader = new FXMLLoader(VueConstruireUneStationDeRecherche.class.getResource("vues/construireunestationderecherche.fxml"));
        try {
            fxmlLoader.load();
        } catch (IOException e) {
        ...
        VueConstruireUneStationDeRecherche vue = fxmlLoader.getController();
