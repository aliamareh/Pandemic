...
public class VueTraiterUneMaladie extends Vue implements VueInteractive, EcouteurOrdre {
    ...
    public static VueTraiterUneMaladie creerVue(GestionnaireVueImpl gestionnaireVue)  {
        FXMLLoader fxmlLoader = new FXMLLoader(VueTraiterUneMaladie.class.getResource("vues/traiterunemaladie.fxml"));
        try {
            fxmlLoader.load();
        } catch (IOException e) {
        ...
        VueTraiterUneMaladie vue = fxmlLoader.getController();
