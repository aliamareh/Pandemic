...
public class VueActionRoleRepartiteur extends Vue implements VueInteractive, EcouteurOrdre {
    ...
    public static VueActionRoleRepartiteur creerVue(GestionnaireVueImpl gestionnaireVue)  {
        FXMLLoader fxmlLoader = new FXMLLoader(VueActionRoleRepartiteur.class.getResource("vues/actionrolerepartiteur.fxml"));
        try {
            fxmlLoader.load();
        } catch (IOException e) {
        ...
        VueActionRoleRepartiteur vue = fxmlLoader.getController();
