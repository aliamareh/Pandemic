...
public class VueVolCharteur extends Vue implements VueInteractive, EcouteurOrdre {
    ...
    public static VueVolCharteur creerVue(GestionnaireVueImpl gestionnaireVue)  {
        FXMLLoader fxmlLoader = new FXMLLoader(VueVolCharteur.class.getResource("vues/volcharteur.fxml"));
        try {
            fxmlLoader.load();
        } catch (IOException e) {
        ...
        VueVolCharteur vue = fxmlLoader.getController();
