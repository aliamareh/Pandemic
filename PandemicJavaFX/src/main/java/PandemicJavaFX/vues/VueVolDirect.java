...
public class VueVolDirect extends Vue implements VueInteractive, EcouteurOrdre {
    ...
    public static VueVolDirect creerVue(GestionnaireVueImpl gestionnaireVue)  {
        FXMLLoader fxmlLoader = new FXMLLoader(VueVolDirect.class.getResource("vues/voldirect.fxml"));
        try {
            fxmlLoader.load();
        } catch (IOException e) {
        ...
        VueVolDirect vue = fxmlLoader.getController();
