...
public class VueActionRoleExpertAuxOperation extends Vue implements VueInteractive, EcouteurOrdre {
    ...
    public static VueActionRoleExpertAuxOperation creerVue(GestionnaireVueImpl gestionnaireVue)  {
        FXMLLoader fxmlLoader = new FXMLLoader(VueActionRoleExpertAuxOperation.class.getResource("vues/actionroleexpertauxoperations.fxml"));
        try {
            fxmlLoader.load();
        } catch (IOException e) {
        ...
        VueActionRoleExpertAuxOperation vue = fxmlLoader.getController();
