...
public class VueNavette extends Vue implements VueInteractive, EcouteurOrdre {
    ...
    public static VueNavette creerVue(GestionnaireVueImpl gestionnaireVue)  {
        FXMLLoader fxmlLoader = new FXMLLoader(VueNavette.class.getResource("vues/navette.fxml"));
        try {
            fxmlLoader.load();
        } catch (IOException e) {
        ...
        VueNavette vue = fxmlLoader.getController();
