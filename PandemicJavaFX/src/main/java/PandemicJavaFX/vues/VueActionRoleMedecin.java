...
public class VueActionRoleMedecin extends Vue implements VueInteractive, EcouteurOrdre {
    ...
    public static VueActionRoleMedecin creerVue(GestionnaireVueImpl gestionnaireVue)  {
        FXMLLoader fxmlLoader = new FXMLLoader(VueActionRoleMedecin.class.getResource("vues/actionrolemedecin.fxml"));
        try {
            fxmlLoader.load();
        } catch (IOException e) {
        ...
        VueActionRoleMedecin vue = fxmlLoader.getController();
