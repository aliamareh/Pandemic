...
public class VuesVoitureOuTransbordeur extends Vue implements VueInteractive, EcouteurOrdre {
    ...
    public static VuesVoitureOuTransbordeur creerVue(GestionnaireVueImpl gestionnaireVue)  {
        FXMLLoader fxmlLoader = new FXMLLoader(VuesVoitureOuTransbordeur.class.getResource("vues/voitureoutransbordeur.fxml"));
        try {
            fxmlLoader.load();
        } catch (IOException e) {
        ...
        VuesVoitureOuTransbordeur vue = fxmlLoader.getController();
