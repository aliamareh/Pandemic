...
public class VueActionRolePlanificateur extends Vue implements VueInteractive, EcouteurOrdre {
    ...
    public static VueActionRolePlanificateur creerVue(GestionnaireVueImpl gestionnaireVue)  {
        FXMLLoader fxmlLoader = new FXMLLoader(VueActionRolePlanificateur.class.getResource("vues/actionroleplanificateur.fxml"));
        try {
            fxmlLoader.load();
        } catch (IOException e) {
        ...
        VueActionRolePlanificateur vue = fxmlLoader.getController();
